...
// TestFont_MFCVS2010_NativeDlg.cpp : implementation file
//

#include "stdafx.h"
#include "TestFont_MFCVS2010_Native.h"
#include "TestFont_MFCVS2010_NativeDlg.h"
...
CTestFont_MFCVS2010_NativeDlg::CTestFont_MFCVS2010_NativeDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CTestFont_MFCVS2010_NativeDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CTestFont_MFCVS2010_NativeDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CTestFont_MFCVS2010_NativeDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CTestFont_MFCVS2010_NativeDlg::OnBnClickedButton1)
	ON_CBN_SELCHANGE(IDC_COMBO1, &CTestFont_MFCVS2010_NativeDlg::OnCbnSelchangeCombo1)
END_MESSAGE_MAP()


// CTestFont_MFCVS2010_NativeDlg message handlers

BOOL CTestFont_MFCVS2010_NativeDlg::OnInitDialog()
{
...
void CTestFont_MFCVS2010_NativeDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CTestFont_MFCVS2010_NativeDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CTestFont_MFCVS2010_NativeDlg::OnQueryDragIcon()
{
...
void CTestFont_MFCVS2010_NativeDlg::OnBnClickedButton1()
{
...
void CTestFont_MFCVS2010_NativeDlg::OnCbnSelchangeCombo1()
{
	// TODO: Add your control notification handler code here
		CString barcodestr;		
	int index = m_combo_barcode.GetCurSel();
