...
module net {
    export module connectcode {
        ...
        export class GS1Databar14 extends CCBarcode {

            linkage: boolean = false;
            constructor(data: string, linkage: boolean= false) {
                super(data, false);
                this.linkage = linkage;                               
            }

            GS1_MOD_10_HRT(data: string): string {
                var result: string;
                var multi: number;
                var total: number;
                var cv: number;
            ...
            encode(): string {
                ...
                var widthsodd:number[] = new Array(4);
                var widthseven:number[] = new Array(4);
                var results1odd: number[] = new Array(4);
                var results2odd: number[] = new Array(4);
                var results3odd: number[] = new Array(4);
                var results4odd: number[] = new Array(4);

                var results1even: number[] = new Array(4);
                var results2even: number[] = new Array(4);
                var results3even: number[] = new Array(4);
                var results4even: number[] = new Array(4);
                ...
                cd = "";
                result = "";
                filtereddata = this.filterInput_GS1Databar14(this.data);
                ...
                if (filteredlength < 14) {
                    ...
                    filtereddata = filtereddata + this.GS1_MOD_10_HRT(filtereddata);

                }

                humanText = "(01)" + this.Right(filtereddata, 14);
                this.connectcode_human_readable_text = this.html_escape(humanText);

                filtereddata = filtereddata.substr(0, 13);

                if (this.linkage == true)
                ...
                data4 = right % 1597;
                retval = this.getGS1W(data1, 1, 16, widthsodd);
                retval = this.getGS1W(data1, 0, 16, widthseven);
                ...
                retval = this.getGS1W(data2, 1, 15, widthsodd);
                retval = this.getGS1W(data2, 0, 15, widthseven);
                ...
                retval = this.getGS1W(data3, 1, 16, widthsodd);
                retval = this.getGS1W(data3, 0, 16, widthseven);
                ...
                retval = this.getGS1W(data4, 1, 15, widthsodd);
                retval = this.getGS1W(data4, 0, 15, widthseven);
                ...
                bwresult = this.html_escape(bwresult);
                return bwresult;

            }


        Right(str:string, n:number) {
            if (n <= 0)
                return "";
            ...
            filterInput_GS1Databar14(data: string): string {
            var datalength = 0;
        ...
        combins__GS1Databar14(n:number, r:number):number {
            var i = 0, j = 0;
        ...
        getGS1widths(val:number, n:number, elements:number, maxWidth:number, noNarrow:number, widths:number[]) {
            var temv = val;
            var bar = 0;
            var elmWidth = 0;
            var i = 0;
            ...
            for (bar = 0; bar < elements - 1; bar++) {
                ...
                while (1 > 0) {
                    subVal = this.combins__GS1Databar14(n - elmWidth - 1, elements - bar - 2);
                    if ((noNarrow == 0) && (narrowMask == 0) && (n - elmWidth - (elements - bar - 1) >= elements - bar - 1)) {
                        subVal = subVal - this.combins__GS1Databar14(n - elmWidth - (elements - bar), elements - bar - 2);
                    }
                    if (elements - bar - 1 > 1) {
                        lessVal = 0;
                        mxwElement = n - elmWidth - (elements - bar - 2);
                        while (mxwElement > maxWidth) {
                            lessVal = lessVal + this.combins__GS1Databar14(n - elmWidth - mxwElement - 1, elements - bar - 3);
        ...
        getGS1W(data:number, oddeven:number, modules:number, widths:number[]) {
            var retval = 0;
                ...
                if (oddeven == 0) {
                    for (var x = 0; x < 5; x++) {
                        if (data >= WIDTH16_4_0[x][0] && data <= WIDTH16_4_0[x][1]) {
                            ...
                            retval = this.getGS1widths(Math.floor((data - WIDTH16_4_0[x][0]) % WIDTH16_4_0[x][2]), WIDTH16_4_0[x][3], WIDTH16_4_0[x][4], WIDTH16_4_0[x][5], WIDTH16_4_0[x][6], widths);
                    ...
                    for (x = 0; x < 5; x++) {
                        if (data >= WIDTH16_4_1[x][0] && data <= WIDTH16_4_1[x][1]) {
                            ...
                            retval = this.getGS1widths(Math.floor((data - WIDTH16_4_1[x][0]) / WIDTH16_4_1[x][2]), WIDTH16_4_1[x][3], WIDTH16_4_1[x][4], WIDTH16_4_1[x][5], WIDTH16_4_1[x][6], widths);
                        }
                ...
                if (oddeven == 0) {
                    ...
                    for (x = 0; x < 4; x++) {
                        if (data >= WIDTH15_4_0[x][0] && data <= WIDTH15_4_0[x][1]) {
                            retval = this.getGS1widths(Math.floor((data - WIDTH15_4_0[x][0]) / WIDTH15_4_0[x][2]), WIDTH15_4_0[x][3], WIDTH15_4_0[x][4], WIDTH15_4_0[x][5], WIDTH15_4_0[x][6], widths);
                        }
                    }
                    ...
                    for (x = 0; x < 4; x++) {
                        if (data >= WIDTH15_4_1[x][0] && data <= WIDTH15_4_1[x][1]) {
                            retval = this.getGS1widths(Math.floor((data - WIDTH15_4_1[x][0]) % WIDTH15_4_1[x][2]), WIDTH15_4_1[x][3], WIDTH15_4_1[x][4], WIDTH15_4_1[x][5], WIDTH15_4_1[x][6], widths);
                        }
                    }
