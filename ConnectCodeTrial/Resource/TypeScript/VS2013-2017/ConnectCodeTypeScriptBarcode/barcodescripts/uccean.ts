...
module net {
    export module connectcode {
        ...
        export class UCCEAN extends CCBarcode {
            gs1Compliance: boolean = true;
            constructor(data: string, gs1Compliance: boolean= true) {
                super(data, false);       
                    ...
                    while (x < replacedata234.length) {
                        ...
                        if (Skip == 0) {
                            ...
                            if (barcodechar1 >= 48 && barcodechar1 <= 57 && barcodechar2 >= 48 && barcodechar2 <= 57) {
                                var num:number = parseInt(replacedata234.substr(x, 2), 10);
        ...
        replaceUCCEAN(data:string, fncvalue:number, GS1Compliance:boolean) {
            var replaceUCCEAN = "";
            var Result = "";
            ...
            for (var counter:number = 0; counter < 8; counter++) {
            ...
            if (numset == 0) {
                ...
                if (forceNULL == 1) {
                    ...
                    var fncstring:string = String.fromCharCode(fncvalue);
                    for (x = 0; x < numset; x++) {
                        if (x == numset - 1) {
        ...
        replaceUCCEANText(data:string, fncvalue:number, GS1Compliance:boolean) {
            var replaceUCCEAN = "";
            var Result = "";
            var datalength = data.length;
            var forceNULL = 0;
        ...
        getCode128CCharacter(inputvalue:number) {
            ...
            OptimizeNumbers(data:string, x: number, strResult:string, num: number) {

            var BtoC: string = String.fromCharCode(231);
            var strResult:string = strResult + BtoC;
        ...
        getAutoSwitchingAB(data:string) {
            ...
            for (x = 0; x < datalength; x++) {
                ...
                if ((barcodevalue <= 31) && (barcodevalue >= 0)) {
                    ...
                    var num:number = this.ScanAhead_8orMore_Numbers(data, x);
                    if (num >= 8) {
        ...
        detectAllNumbers(data:string, GS1Compliance:boolean):boolean {
            var result = "";
            var allnumbers = 1;
            var numNumbers = 0;
            var datalength = data.length;
