...
(function (net) {
    (function (connectcode) {
        var EXT5 = (function (_super) {
            __extends(EXT5, _super);
            function EXT5(data) {
                _super.call(this, data, false);
            }
            EXT5.prototype.encode = function () {
            ...
            EXT5.prototype.filterInput = function (data) {
                var Result = "";
