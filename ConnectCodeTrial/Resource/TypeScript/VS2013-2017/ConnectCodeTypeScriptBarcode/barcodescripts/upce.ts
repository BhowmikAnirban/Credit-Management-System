...
module net {
    export module connectcode {
        ...
        export class UPCE extends CCBarcode {
            hr: boolean=false;
	    ...
	    getUPCECharacter(inputdecimal:number):number {
            ...
            DeleteSubString(orgStr: string, start: number, length: number) {
        ...
        InsertSubString(orgStr:string, insertStr:string, start:number) {
            var fulllength = orgStr.length;
            var leftstr = "";
            var rightstr = "";
