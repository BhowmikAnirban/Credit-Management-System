...
(function (net) {
    (function (connectcode) {
        var I2of5 = (function (_super) {
            __extends(I2of5, _super);
            function I2of5(data, checkDigit) {
                if (typeof checkDigit === "undefined") { checkDigit = false; }
                _super.call(this, data, checkDigit);
            }
            I2of5.prototype.encode = function () {
                var Result = "";
                var cd = "";
                var filtereddata = "";
            ...
            I2of5.prototype.getI2of5Character = function (inputvalue) {
            ...
            I2of5.prototype.filterInput = function (data) {
                var Result = "";
            ...
            I2of5.prototype.generateCheckDigit = function (data) {
                var datalength = 0;
                var lastcharpos = 0;
                var Result = 0;
                var strResult = "";
