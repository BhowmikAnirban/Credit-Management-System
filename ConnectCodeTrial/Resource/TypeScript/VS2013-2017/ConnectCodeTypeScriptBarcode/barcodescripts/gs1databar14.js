...
(function (net) {
    (function (connectcode) {
        var GS1Databar14 = (function (_super) {
            __extends(GS1Databar14, _super);
            function GS1Databar14(data, linkage) {
                if (typeof linkage === "undefined") { linkage = false; }
                _super.call(this, data, false);
                this.linkage = false;
                this.linkage = linkage;
            }
            GS1Databar14.prototype.GS1_MOD_10_HRT = function (data) {
                var result;
                var multi;
                var total;
                var cv;
            ...
            GS1Databar14.prototype.encode = function () {
                var result = "";
                var cd = "";
                var filtereddata = "";
                var addcharlength = 0;
            ...
            GS1Databar14.prototype.Right = function (str, n) {
                if (n <= 0)
                    return "";
            ...
            GS1Databar14.prototype.filterInput_GS1Databar14 = function (data) {
                var datalength = 0;
            ...
            GS1Databar14.prototype.combins__GS1Databar14 = function (n, r) {
                var i = 0, j = 0;
            ...
            GS1Databar14.prototype.getGS1widths = function (val, n, elements, maxWidth, noNarrow, widths) {
                var temv = val;
                var bar = 0;
                var elmWidth = 0;
                var i = 0;
            ...
            GS1Databar14.prototype.getGS1W = function (data, oddeven, modules, widths) {
                var retval = 0;
        ...
        connectcode.GS1Databar14 = GS1Databar14;
    })(net.connectcode || (net.connectcode = {}));
    var connectcode = net.connectcode;
})(net || (net = {}));
//# sourceMappingURL=gs1databar14.js.map
