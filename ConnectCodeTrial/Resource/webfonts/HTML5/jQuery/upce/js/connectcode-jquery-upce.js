 ...
 */
	...
	;(function($) {
		$.fn.Encode_UPCE = function(options) {
			var opts = $.extend({}, $.fn.Encode_UPCE.defaults, options);
			return this.each(function() {
				if ($(this).text()!="")
				{
					opts.data=$(this).text();
				}
				$(this).text(ConnectCode_Encode_UPCE(opts.data,opts.hr,opts.humanReadableTextOutput));
			});
		};

		$.Encode_UPCE = function(data,hr,humanReadableTextOutput) {
			return ConnectCode_Encode_UPCE(data,hr,humanReadableTextOutput);
		};
				

		function ConnectCode_Encode_UPCE(data,hr,humanReadableTextOutput)
		{
