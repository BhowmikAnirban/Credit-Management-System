 ...
 */
	...
	;(function($) {
		$.fn.Encode_UCCEAN = function(options) {
			var opts = $.extend({}, $.fn.Encode_UCCEAN.defaults, options);
			return this.each(function() {
				if ($(this).text()!="")
				{
					opts.data=$(this).text();
				}
				$(this).text(ConnectCode_Encode_UCCEAN(opts.data,opts.gs1Compliance,opts.humanReadableTextOutput));
			});
		};

		$.Encode_UCCEAN = function(data, GS1Compliance,humanReadableTextOutput) {
			return ConnectCode_Encode_UCCEAN(data,GS1Compliance,humanReadableTextOutput);
		};
				

		function ConnectCode_Encode_UCCEAN(data,GS1Compliance,humanReadableTextOutput)
		{
			 ...
			 {
				return html_decode(html_escape(replacedata234text));
			 }
