 ...
 */
	...
	;(function($) {
		$.fn.Encode_Code128A = function(options) {
			var opts = $.extend({}, $.fn.Encode_Code128A.defaults, options);
			return this.each(function() {
				if ($(this).text()!="")
				{
					opts.data=$(this).text();
				}
				$(this).text(ConnectCode_Encode_Code128A(opts.data,opts.humanReadableTextOutput));
			});
		};

		$.Encode_Code128A = function(data) {
			return ConnectCode_Encode_Code128A(data,humanReadableTextOutput);
		};
				

		function ConnectCode_Encode_Code128A(data,humanReadableTextOutput)
		{
                   var cd = "";
                   var Result = "";
			 ...
			 {
				return html_decode(html_escape(Result));	
			 }
