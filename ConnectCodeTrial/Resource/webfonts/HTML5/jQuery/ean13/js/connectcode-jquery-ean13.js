 ...
 */
	...
	;(function($) {
		$.fn.Encode_EAN13 = function(options) {
			var opts = $.extend({}, $.fn.Encode_EAN13.defaults, options);
			return this.each(function() {
				if ($(this).text()!="")
				{
					opts.data=$(this).text();
				}
				$(this).text(ConnectCode_Encode_EAN13(opts.data,opts.hr,opts.humanReadableTextOutput));
			});
		};

		$.Encode_EAN13 = function(data,humanReadableTextOutput) {
			return ConnectCode_Encode_EAN13(data,hr,humanReadableTextOutput);
		};
				
		function ConnectCode_Encode_EAN13(data,hr,humanReadableTextOutput)
		{
