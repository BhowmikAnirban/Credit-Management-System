 ...
 */
	...
	;(function($) {
		$.fn.Encode_Industrial2OF5 = function(options) {
			var opts = $.extend({}, $.fn.Encode_Industrial2OF5.defaults, options);
			return this.each(function() {
				if ($(this).text()!="")
				{
					opts.data=$(this).text();
				}
				$(this).text(ConnectCode_Encode_Industrial2OF5(opts.data,opts.checkDigit,opts.humanReadableTextOutput));
			});
		};

		$.Encode_Industrial2OF5 = function(data,checkDigit,humanReadableTextOutput) {
			return ConnectCode_Encode_I2OF5(data,checkDigit,humanReadableTextOutput);
		};
				
		function ConnectCode_Encode_Industrial2OF5(data,checkDigit,humanReadableTextOutput)
		{
			var Result="";
			var cd="";
			var filtereddata="";
		...
		$.fn.Encode_Industrial2OF5.defaults = {
			data: "12345678",
			checkDigit: 1,
