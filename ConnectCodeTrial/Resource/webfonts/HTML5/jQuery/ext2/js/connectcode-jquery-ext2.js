 ...
 */
	...
	;(function($) {
		$.fn.Encode_EXT2 = function(options) {
			var opts = $.extend({}, $.fn.Encode_EXT2.defaults, options);
			return this.each(function() {
				if ($(this).text()!="")
				{
					opts.data=$(this).text();
				}
				$(this).text(ConnectCode_Encode_EXT2(opts.data,opts.humanReadableTextOutput));
			});
		};

		$.Encode_EXT2 = function(data,humanReadableTextOutput) {
			return ConnectCode_Encode_EXT2(data,humanReadableTextOutput);
		};
				

		function ConnectCode_Encode_EXT2(data,humanReadableTextOutput)
		{
