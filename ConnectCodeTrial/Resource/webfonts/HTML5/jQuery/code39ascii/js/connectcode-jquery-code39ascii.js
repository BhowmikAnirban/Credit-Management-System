 ...
 */
	...
	;(function($) {
		$.fn.Encode_Code39ASCII = function(options) {
			var opts = $.extend({}, $.fn.Encode_Code39ASCII.defaults, options);
			return this.each(function() {
				if ($(this).text()!="")
				{
					opts.data=$(this).text();
				}
				$(this).text(ConnectCode_Encode_Code39ASCII(opts.data,opts.checkDigit,opts.humanReadableTextOutput));
			});
		};

		$.Encode_Code39ASCII = function(data,checkDigit,humanReadableTextOutput) {
			return ConnectCode_Encode_Code39ASCII(data,checkDigit,humanReadableTextOutput);
		};
				

		function ConnectCode_Encode_Code39ASCII(data,checkDigit,humanReadableTextOutput)
		{
			var Result="";
			var cd="";
			var filtereddata="";
			...
			{
				 Result = "*" + connectcode_human_readable_text + cd + "*";
		...
		$.fn.Encode_Code39ASCII.defaults = {
			data: "12345678",
			checkDigit: 1,
