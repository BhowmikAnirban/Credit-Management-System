 ...
 */
	...
	;(function($) {
		$.fn.Encode_GS1Databar14 = function(options) {
			var opts = $.extend({}, $.fn.Encode_GS1Databar14.defaults, options);
			return this.each(function() {
				if ($(this).text()!="")
				{
					opts.data=$(this).text();
				}
				$(this).text(ConnectCode_Encode_GS1Databar14(opts.data,opts.linkage,opts.humanReadableTextOutput));
			});
		};

		$.Encode_GS1Databar14 = function(data,linkage,humanReadableTextOutput) {
			return ConnectCode_Encode_GS1Databar14(data,linkage,humanReadableTextOutput);
		};
		...
		function ConnectCode_Encode_GS1Databar14( data , linkage,humanReadableTextOutput) 
            {  
                  var result=""; 
                  var cd=""; 
                  var filtereddata=""; 
			...
			{
				return html_decode(html_escape(humanText));	                  
			}
...
var temv=val;
		...
		$.fn.Encode_GS1Databar14.defaults = {
			data: "12345678",
			linkage: 0,
