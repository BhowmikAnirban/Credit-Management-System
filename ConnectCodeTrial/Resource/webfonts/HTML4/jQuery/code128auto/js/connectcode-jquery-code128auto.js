 ...
 */
	...
	;(function($) {
		$.fn.Encode_Code128Auto = function(options) {
			var opts = $.extend({}, $.fn.Encode_Code128Auto.defaults, options);
			return this.each(function() {
				...
				$(this).text(ConnectCode_Encode_Code128Auto(opts.data,opts.humanReadableTextOutput));
			});
		};

		$.Encode_Code128Auto = function(data) {
			return ConnectCode_Encode_Code128Auto(data,humanReadableTextOutput);
		};
				

		function ConnectCode_Encode_Code128Auto(data,humanReadableTextOutput)
		{
		...
		$.fn.Encode_Code128Auto.defaults = {
			data: "12345678",
