 ...
 */
	...
	;(function($) {
		$.fn.Encode_EXT5 = function(options) {
			var opts = $.extend({}, $.fn.Encode_EXT5.defaults, options);
			return this.each(function() {
				if ($(this).text()!="")
				{
					opts.data=$(this).text();
				}
				$(this).text(ConnectCode_Encode_EXT5(opts.data,opts.humanReadableTextOutput));
			});
		};

		$.Encode_EXT5 = function(data,humanReadableTextOutput) {
			return ConnectCode_Encode_EXT5(data,humanReadableTextOutput);
		};
				

		function ConnectCode_Encode_EXT5(data,humanReadableTextOutput)
		{
