 ...
 */
	...
	;(function($) {
		$.fn.Encode_Code93 = function(options) {
			var opts = $.extend({}, $.fn.Encode_Code93.defaults, options);
			return this.each(function() {
				if ($(this).text()!="")
				{
					opts.data=$(this).text();
				}
				$(this).text(ConnectCode_Encode_Code93(opts.data,opts.checkDigit,opts.humanReadableTextOutput));
			});
		};

		$.Encode_Code93 = function(data,checkDigit) {
			return ConnectCode_Encode_Code93(data,checkDigit,humanReadableTextOutput);
		};
				
		function ConnectCode_Encode_Code93(data,checkDigit,humanReadableTextOutput)
		{
			var Result="";
			var cd="";
			var filtereddata="";
			...
			{
				connectcode_human_readable_text=html_decode(html_escape(filtereddata+textcd));
