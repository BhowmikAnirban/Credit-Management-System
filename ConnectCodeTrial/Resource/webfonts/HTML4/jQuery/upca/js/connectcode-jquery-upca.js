 ...
 */
	...
	;(function($) {
		$.fn.Encode_UPCA = function(options) {
			var opts = $.extend({}, $.fn.Encode_UPCA.defaults, options);
			return this.each(function() {
				if ($(this).text()!="")
				{
					opts.data=$(this).text();
				}
				$(this).text(ConnectCode_Encode_UPCA(opts.data,opts.hr,opts.humanReadableTextOutput));
			});
		};

		$.Encode_UPCA = function(data,hr,humanReadableTextOutput) {
			return ConnectCode_Encode_UPCA(data,hr,humanReadableTextOutput);
		};
				


		function ConnectCode_Encode_UPCA(data,hr,humanReadableTextOutput)
		{
                   var cd = "";
                   var Result = "";
